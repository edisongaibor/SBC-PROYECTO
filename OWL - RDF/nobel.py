...
def nations():
#GET: RETORNA LOS NOMBRES DE TODAS LAS NACIONES
    qres = g.query(
            """
            PREFIX table:<http://swat.cse.lehigh.edu/resources/onto/nobel.owl#>
            PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>
...
def getYear():
#GET: RETORNA LA LISTA DE GANADORES POR AÑO
...
def getNation():
#GET: RETORNA LA LISTA DE GANADORES POR NACION
...
def getCategory():
#GET: RETORNA LA LISTA DE GANADORES POR CATEGORIA
...
def getYearCategory():
#GET: RETORNA LA LISTA DE GANADORES POR CATEGORIA Y AÑO
    category = request.form.get('category')
...
def getDetails(name):
#GET: RETORNA LOS DETALLES DEL GANADOR DEL NOBEL
    name = name
    qres = g.query(
    """
    PREFIX table:<http://swat.cse.lehigh.edu/resources/onto/nobel.owl#>
